...
_C.DATA.TRAIN_DATA_PATH = os.path.join(_C.DATA.BASE_INPUT_PATH, 'train_latest.csv')
...
_C.OUTPUT.PREDS_PATH = os.path.join(os.getcwd(), "output/predictions/repeated_10fold")
...
_C.EVAL.N_REPEATS = 10 # 1 for loocv 
